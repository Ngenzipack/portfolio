...
export const projects: ProjectItem[] = [
  {
    ...
    category: "Cloud Security - Identity and Access Management",
    period: "2026",
    role: "Designer and Implementer",
    description:
      "Enterprise-style security implementation for an education environment: segmented Azure VNets connected to a simulated on-premises network through VPN, with Entra ID, MFA, Conditional Access, RBAC, and Sentinel monitoring layered on top.",
    outcomes: [
      "Two VNets with eight subnets and over fifteen NSG rules enforcing least privilege between Staff, Students, and Servers.",
      "Four Conditional Access policies enforcing MFA, compliant devices, and blocked legacy authentication for thirty governed identities.",
      "Sentinel alert rules and KQL detections for failed logins, risky sign-ins, and suspicious authentication review through Log Analytics.",
    ],
    technologies: [
      "Microsoft Azure",
      "Microsoft Entra ID",
  ...
  },
  {
    ...
    role: "Lab Architect",
    description:
      "Enterprise segmentation lab covering staff, student, guest, IoT, VoIP, and server traffic with Fortinet-focused firewall rules, inter-VLAN routing, VPN concepts, and Wireshark validation.",
    outcomes: [
      "Documented topology and security boundaries in Visio to show approved flows, segmentation controls, and validation evidence.",
      "Guest and IoT isolation modeled to reduce lateral-movement risk across user and device groups.",
      "Reusable runbook for firewall policy design, packet-flow testing, validation, and rollback.",
    ],
    technologies: [
      "Cisco",
      "Fortinet",
  ...
  },
  {
    ...
    title: "Neotha - Owner-Led Client Platform and Server Operations",
    category: "DevSecOps - Full-Stack Platform",
    period: "Ongoing",
    role: "Owner, Founder, and Lead Engineer",
    description:
      "Owner-led web and technology practice where I build frontend and backend systems, support customers, manage hosting and server environments, and apply secure deployment habits across live client platforms.",
    outcomes: [
      "Deliver production websites and client systems using Next.js, TypeScript, React, backend integrations, SEO metadata, and accessibility-aware interfaces.",
      "Manage DNS, SSL/TLS, hosting configuration, deployment troubleshooting, uptime support, and customer requests for live business websites.",
      "Use security-minded operations: environment separation, dependency hygiene, least-privilege access, backups, documentation, and careful change management.",
    ],
    technologies: [
      "Next.js",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "Client-facing web platform delivered with professional frontend, backend, hosting, and operational support. The work demonstrates real customer ownership beyond lab projects: requirements, implementation, deployment, troubleshooting, and secure server management.",
    outcomes: [
      "Built and maintained a live multilingual web experience with clean navigation, responsive UI, and public-facing business reliability.",
  ...
  },
  {
    ...
    description:
      "Production-style monitoring and automation work using SolarWinds/PRTG patterns, PowerShell, user lifecycle checks, stale-account review, event-log collection, and security follow-up.",
    outcomes: [
      "Centralized monitoring concepts for availability and security signals.",
      "PowerShell workflows for provisioning review, stale-account checks, event-log collection, and access auditing.",
      "Repeatable patterns that reduce manual workload and improve security follow-through.",
    ],
    technologies: [
      "SolarWinds",
      "PRTG",
  ...
  {
    slug: "secure-web-client-work",
    title: "Secure Web and Client Delivery Portfolio",
    category: "Software Engineering - Client Platforms",
    period: "2023 - Present",
    ...
    outcomes: [
      ...
      "Kept public GitHub work active with Python and JavaScript fundamentals to support broader engineering discipline.",
    ],
    technologies: [
      "TypeScript",
      "JavaScript",
